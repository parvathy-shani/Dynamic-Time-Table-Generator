...
def calculate_fitness(schedule, weights, room_capacity, lecturer_time_constraints, lecturer_time_preferences):
    ...
    total_violation = weights[0] * v1 + weights[1] * v2 + weights[2] * v4 + weights[4] * v5
...
def main():
    input_file_path = "formatted_initial_population.txt"
    output_file_path = 'fitness_scores.txt'
